...
const STORY={
 ...
 north1:{title:'',text:`<p>Le Resolute remonte vers le nord.</p><p>Le paysage change peu à peu. De petites îles basses apparaissent, séparées par des chenaux profonds. Certaines ne sont que des bandes de sable couvertes de végétation. D’autres portent les restes de cabanes abandonnées.</p><p>Vous passez près d’une épave ancienne échouée sur un récif. Il ne reste de la coque que quelques membrures noircies dressées hors de l’eau.</p><p>Personne n’a besoin de rappeler pourquoi cette zone est évitée par les marchands isolés.</p><p>Vers le milieu de l’après-midi, une voile apparaît derrière une île.</p><p>Le bâtiment ne porte aucun pavillon.</p><p>Il conserve d’abord sa route.</p><p>Puis il vire.</p><p>Droit vers vous.</p><p>Quelques minutes plus tard, un pavillon noir monte lentement au mât.</p><p>Sur le pont du Resolute, tes soldats prennent leurs armes sans attendre ton ordre.</p>`,choices:[{label:'Préparer la défense',to:'north2',effect:s=>startCrewBattle(s,'piratesNorth',12,5,3,0)}]},
 ...
 north4:{title:'',text:s=>`<p>Une fois le capitaine à terre, les derniers pirates cessent de résister.</p><p>Tu fais fouiller rapidement leur bâtiment avant de reprendre la recherche du Providence.</p><p>Dans une caisse dissimulée sous des toiles, tes hommes trouvent une petite bourse contenant <strong>dix pièces d’or</strong>.</p><p>À côté, cinq lames courtes ont été rangées dans un étui de cuir. Leur poids est parfaitement équilibré.</p><p><strong>Tu récupères 5 lames de lancer.</strong></p><p>Plus loin dans la cale, un petit tonnelet de rhum porte encore le sceau d’un négociant de Port Royal.</p><p>Il pourrait être bu, offert ou servir de marchandise si vous deviez négocier plus tard.</p>`,onEnter:s=>{if(!s.flags.northPirateLoot){s.flags.northPirateLoot=true;addGold(s,10);addThrowingBlades(s,5);}},choices:[
